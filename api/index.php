...
switch ($uri[2]) {
    ...
    case "orders" : {
        ...
        // Inspect and transform URL queries
        $urlQuery = $sanitize->unpackQueries($urlQuery);
        $urlQuery = $sanitize->validateQueries($urlQuery, ["finished", "quantity", "order_item_id", "delete-item", "all-by-user", "unfinished", "limit", "order-by-asc", "order-by-desc", "show-all", "search"]);
