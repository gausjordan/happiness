...
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products_and_categories` VALUES (1,1,5),(7,2,5),(8,3,2),(9,4,2),(10,5,1),(11,6,1),(12,7,1),(13,8,3),(14,9,3),(15,10,3),(16,11,4),(17,12,4),(18,13,3),(246,14,1),(257,115,3),(258,116,4),(262,114,2);
...
INSERT INTO `products_and_tags` VALUES (1,1,1),(6,2,4),(7,2,3),(8,3,1),(9,4,2),(10,5,1),(11,6,1),(12,7,2),(13,8,1),(14,9,4),(15,10,1),(16,10,3),(17,11,1),(18,12,3),(19,13,1),(20,14,3),(243,115,4),(431,116,2),(432,116,3),(438,114,3),(439,114,4);
...
INSERT INTO `user` VALUES (9,'admin','Admin','Kazafmuradadminović','admin@lolzfords.lol','0951234567','Fulfinumska ulica','24',54947,'Ćepikućke kotline','Slovenija','$2y$10$/oacbl8rjA7xA4CojMdkGuW49gsoin3is.Of0MAsCmFxIeJsdnqJi',4),(10,'user','Korisnik','Korisniković','korisnik@usel.es','0911234567','Lješnjačkih brigada','87',10000,'Zagreb','Hrvatska','$2y$10$qXvldyVAe4Zg5v2JBBVmUOP2iwMQZSdQcTqTxR0osiNp02FnQ.YzS',2),(11,'employee','Šljakana','Radnik','dradnik~1@oldschool.hr','097654321','Huplanova','11d',12555,'Balvanovo','Hrvatska','$2y$10$4GWLV8VaPCOwYtgXiJyt0OkHgiA6LzOnocIw7zGfD/ZM4i5unx8Y2',3),(34,'bozo','Lucijan-Bozo','Juzerčić','bozo@lolzords.lol','8888888888','Fulfinumska ulica','04',23237,'Pufkovljanec Gornji','Hrvatska','$2y$10$LJGhswtVRYxSXyUbg8GUeetIuO3wQMRpfvDqsd8D/BpJnCapqwIri',2),(41,'kkk','kkk','kkk','kkk@kkk.kk','1233540','kkk','kkk',34310,'Kadanovci','Požeško-slavonska','$2y$10$0zZc//NPoywhjk2uj4e4je8IGlqmHAhcr7Q6hYw8Pfb5cIIG7ysma',2);
...
-- Dump completed on 2025-08-05  2:56:26
