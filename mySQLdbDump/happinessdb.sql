...
INSERT INTO `order_items` VALUES (2,3,2,30.30),(2,14,1,10.00),(3,6,1,71.00),(3,9,1,100.00),(3,11,1,6.00);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `order_user_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `orders` VALUES (2,10,'2025-02-01','2025-02-05',1,1,0,0,0,'Dovršena transakcija.'),(3,10,'2025-02-07',NULL,0,0,0,0,0,'Nekompletna transakcija');
...
-- Dump completed on 2025-02-09  3:26:24
